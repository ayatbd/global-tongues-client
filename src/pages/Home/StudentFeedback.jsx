      ...
      <section className="bg-gray-50 py-20">
        ...
        >
          ...
          >
            ...
            <a className="mt-6 cursor-pointer inline-flex shrink-0 items-center gap-2 rounded-full border border-rose-600 px-5 py-3 text-rose-600 transition hover:bg-rose-600 hover:text-white md:mt-0">
